                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        const SizedBox(width: 8),
                        Expanded(child: _statBoxLight('Total Tonase', '${formatTonase(stats?['total_tonase'] ?? 0)} Kg', Colors.white)),
                      ]),
                    ],
                  ),
                ),
        ...
        return Container(
          ...
          child: Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 3),
              Text('${n['tanggal']}  •  ${formatTonase(n['berat_kg'])} Kg × ${formatRp(n['harga_per_kg'])}', style: TextStyle(fontSize: 10, color: Colors.grey.shade600)),
            ])),
